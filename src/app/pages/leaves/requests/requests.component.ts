...
export class RequestsComponent {
  ...
  userCompanyInfo: WritableSignal<any | null> =
    this.profilesService.userCompanyInfo;
  userManagerInfo: WritableSignal<any | null> =
    this.profilesService.userManagerInfo;
