...
@Component({
  selector: 'app-official-leave-check',
  standalone: true,
  imports: [MaterialsModule, CommonModule, AsyncPipe],
  templateUrl: './official-leave-check.component.html',
  styleUrl: './official-leave-check.component.scss'
})
export class OfficialLeaveCheckComponent {
